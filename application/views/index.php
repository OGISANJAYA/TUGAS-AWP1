...
<html lang="en">
  ...
  <body>
	...
	<div class="well">
	  <div class="row">
		<div class="span">
		  <h3>Aplikasi CRUD Buku Tamu</h3>
		   <p>Oleh <a href="" target="_blank">OgiSanjaya</a></p> 
		</div>
	  </div>
	</div>
	<?php if($message == 1){ ?>
  ...
  <table class="table table-hover table-condensed">
	...
	<?php } ?>
      ...
      <footer class="well">
        <p>
        	Programming By : OgiSanjaya <br />
            Design By : OgiSanjaya
        </p>
      </footer>
